...
public interface NcdPatientCardReportDAO {
	 ...
	 * @param locationUuid only include encounters recorded at this location, or null for all locations
	 ...
	 */
	List<Object[]> getNcdPatientCardReport(Date startDate, Date endDate, String locationUuid) throws DAOException;
}
