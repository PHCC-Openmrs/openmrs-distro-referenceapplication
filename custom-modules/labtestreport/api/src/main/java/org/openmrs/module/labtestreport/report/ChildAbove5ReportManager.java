...
/**
 * Registers the Nutrition Report - Child Above 5 with the Reporting module so it also shows up in
 * the O3 Reports dashboard (as a plain table, without the admin page's clickable rows).
 */
public class ChildAbove5ReportManager extends BaseReportManager {

	public static final String UUID = "1c2d3e4f-5a6b-4c7d-8e9f-0a1b2c3d4e5f";
	...
	public String getName() {
		return "Nutrition Report - Child Above 5";
	}

	@Override
	public String getDescription() {
		return "Beneficiaries currently 5 or older, registered under the Nutrition Registration CU5 and/or "
	...
	public ReportDefinition constructReportDefinition() {
		...
		dataSetDefinition.setSqlQuery(NutritionReportSql.buildPreviewSql(false));
		for (Parameter parameter : getParameters()) {
			dataSetDefinition.addParameter(parameter);
		}

		reportDefinition.addDataSetDefinition("nutritionChildAbove5", Mapped.mapStraightThrough(dataSetDefinition));
